...
.dot {
    ...
    <div class="carousel-item active">
        ...
        <div class="carousel-caption d-flex align-items-start justify-content-center text-start">
            <div class="mx-sm-5 px-5" style="max-width: 900px;">
                <h1 class="display-2 text-red text-uppercase mb-4 animated slideInDown" style="color:red">{{__('messages.carousel_hello')}}</h1>
                <!-- Add Button -->
                <center>
                <button class="btn btn-primary" style="margin-top:200px" onclick="openVideoWindow('{{ asset('videos/video_1.mp4') }}')">{{__('messages.carousel_play_video')}}</button>
                </center>
            </div>
        </div>
    </div>
    <div class="carousel-item">
        ...
        <div class="carousel-caption d-flex align-items-start justify-content-center text-start">
            <div class="mx-sm-5 px-5" style="max-width: 900px;">
                <h1 class="display-2 text-red text-uppercase mb-4 animated slideInDown" style="color:red">{{__('messages.carousel_windows_version')}}</h1>
                <!-- Add Button -->
                <center>
                <button class="btn btn-primary" style="margin-top:150px" onclick="openVideoWindow('{{ asset('videos/slider_2/slider_2.mp4') }}')">{{__('messages.carousel_play_video')}}</button>
                </center>
            </div>
        </div>
    </div>
    <div class="carousel-item">
        ...
        <div class="carousel-caption d-flex align-items-start justify-content-center text-start">
            <div class="mx-sm-5 px-5" style="max-width: 900px;">
                ...
                <!-- Add Button -->
                <center>
                <button class="btn btn-primary" style="margin-top:150px" onclick="openVideoWindow('{{ asset('videos/slider_3/slider_3.mp4') }}')">{{__('messages.carousel_play_video')}}</button>
                </center>
            </div>
        </div>
    </div>
...
<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
    <div class="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
        ...
        <div class="ps-4">
            <h3 class="text-uppercase mb-3" style="color:red">{{__('messages.microphone_monitor')}}</h3>
...
<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
    <div class="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
        ...
        <div class="ps-4">
            <h3 class="text-uppercase mb-3" style="color:red">{{__('messages.activities_monitor')}}</h3>
                    ...
                    <div class="bg-secondary h-100 d-flex flex-column justify-content-center p-5">
                        ...
                        <div>
                            <div class=" border-bottom py-2">
                                <h6 class="text-uppercase" style="font-size: 25px">• {{__('messages.pricing_live_alerts')}}</h6>
                                <span class="text-uppercase mb-0">{{__('messages.pricing_live_alerts_details_1')}}</span><br>
                                <span class="text-uppercase mb-0">{{__('messages.pricing_live_alerts_details_2')}}</span><br>
                                <span class="text-uppercase mb-0">{{__('messages.pricing_live_alerts_details_3')}}</span><br>
                            </div>
                            <div class=" border-bottom py-2">
                                <h6 class="text-uppercase" style="font-size: 25px">• {{__('messages.pricing_apk_builder')}}</h6>
                                <span class="text-uppercase mb-0">{{__('messages.pricing_apk_builder_details_1')}}</span><br>
                                <span class="text-uppercase mb-0">{{__('messages.pricing_apk_builder_details_2')}}</span><br>
                            </div>
                            <div class=" border-bottom py-2">
                                <h6 class="text-uppercase " style="font-size: 25px">• {{__('messages.pricing_apk')}}</h6>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-0">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-secondary h-100 d-flex flex-column justify-content-center p-5">
                        <p class="d-inline-flex bg-dark text-primary py-1 px-4 me-auto">{{__('messages.working_hours_title')}}</p>
